...
$sql = "SELECT  pizzaId, pizzaDescription,basePrice FROM pizza";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table>
	<tr><td><a href='userloggedin.php'>Back</a></td></tr>
	<tr><th>Pizza Id</th><th>Pizza Description</th><th>Price</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["pizzaId"]."</td><td>".$row["pizzaDescription"]."</td><td>".$row["basePrice"]."</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
