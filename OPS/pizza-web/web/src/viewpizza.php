...
$sql = "SELECT  pizzaId, pizzaName,pizzaDescription,basePrice,img FROM pizza";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table>
	<tr><td><a href='AdminLoggedIn.php'>Back</a></td></tr>
	<tr><th>Pizza Id</th><th>Pizza Name</th><th>Pizza Description</th><th>Price</th><th>Image</th></tr>";
    // output data of each row
 while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["pizzaId"]."</td><td>".$row["pizzaName"]."</td><td>".$row["pizzaDescription"]."</td><td>".$row["basePrice"]."</td></table><td>".$row["img"]."</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
...
?>
		<table><tr><td><img src="../images/cl.png" width="144" height="159">&nbsp;</td></tr>
		</table>
