...
$sql = "SELECT desertId, dessertName, desertDescription, desertPrice FROM desertType";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table>
	<tr><td><a href='userloggedin.php'>Back</a></td></tr>
	<tr><th>Desert Id</th><th>Dessert Name</th><th>Dsert Description</th><th>Price</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["desertId"]."</td><td>".$row["dessertName"]."</td><td>".$row["desertDescription"]."</td><td>".$row["desertPrice"]."</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
