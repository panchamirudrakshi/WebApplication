...
$sql = "SELECT drinkId, drinkName, drinkDescription, drinkPrice FROM drinkType";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table>
	<tr><td><a href='userloggedin.php'>Back</a></td></tr>
	<tr><th>Drink Id</th><th>Drink Name</th><th>Drink Description</th><th>Price</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["drinkId"]."</td><td>".$row["drinkName"]."</td><td>".$row["drinkDescription"]."</td><td>".$row["drinkPrice"]."</td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
